...
SFMVPI(FDA,NAMECHG,SFN) ;Search a variable pointer list for items that do not
 ...
 . I (IEN=0),(REPFI="") D
 ..;Auto-delete in silent mode to avoid interactive prompt
 .. I $G(^TMP("PXRMEXIA",$J,"TYPE"))="SILENT" D  Q
 ... N NE S NE=$O(^TMP("PXRMEXNI",$J,""),-1)+1
 ... S ^TMP("PXRMEXNI",$J,NE,0)=TYPE_" "_FINDING_" does not exist - auto-deleted."
 ... D DELFIND(SFN,IENS,.FDA)
 ..;Get replacement
