...
FILE(PXRMRIEN,SITEIEN,IND120,JND120,ACTION,ATTR,NAMECHG) ;Read and process a
 ...
 ;Strip invalid `0 EDIT BY pointers from all subfiles
 N PSFN,PIENS S PSFN="" F  S PSFN=$O(FDA(PSFN)) Q:PSFN=""  D
 . S PIENS="" F  S PIENS=$O(FDA(PSFN,PIENS)) Q:PIENS=""  D
 .. I $G(FDA(PSFN,PIENS,1))="`0" K FDA(PSFN,PIENS,1)
...
INIEH(FILENUM,IENS,FDA,WPTMP) ;If the file is a clinical reminder file and
 ...
 I +$G(DUZ)>0 S FDA(SFN,IENS,1)="`"_DUZ
